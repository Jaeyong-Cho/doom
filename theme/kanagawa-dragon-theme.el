...
(autothemer-deftheme
 ...
 (
  ...
  (org-scheduled                                 (:foreground dragonAqua))
  (org-scheduled-previously                      (:foreground dragonAqua))
  (org-scheduled-today                           (:foreground dragonAqua :italic t))
  ...
  (org-ellipsis                                  (:foreground waveBlue2 :height 1.3 :bold t))
  (org-level-1                                   (:foreground samuraiRed :height 1.25 :bold t))
  (org-level-2                                   (:foreground dragonBlue :height 1.2 :bold t))
  (org-level-3                                   (:foreground carpYellow :height 1.15))
  (org-level-4                                   (:foreground springGreen :height 1.10))
  (org-level-5                                   (:foreground fujiWhite :height 1.05))

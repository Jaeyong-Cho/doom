...
(autothemer-deftheme
	kanagawa-dragon-tmp "A theme inspired by the colors of the famous painting by Katsushika Hokusa"

 ((((class color) (min-colors #xFFFFFF))        ; col 1 GUI/24bit
   ((class color) (min-colors #xFF)))           ; col 2 Xterm/256

  ;; Define our color palette
  (fujiWhite		"#C5C9C5" "#ffffff")
  (old-white		"#C8C093" "#ffffff")

  (sumiInk-0		"#0D0C0C" "#000000")
  (sumiInk-1b		"#181820" "#000000")
  (sumiInk-1		"#181616" "#080808")
  ...
  ;; org-mode
  (org-link                                      (:foreground springGreen :underline t))
  ...
  (org-todo                                      (:foreground springGreen :bold t))
  (org-scheduled                                 (:foreground waveAqua2))
  (org-scheduled-previously                      (:foreground waveAqua2))
  (org-scheduled-today                           (:foreground waveAqua2 :italic t))
  ...
  (org-level-1                                   (:foreground samuraiRed :bold t))
  (org-level-2                                   (:foreground dragonBlue :bold t))
  (org-level-3                                   (:foreground carpYellow))
  (org-level-4                                   (:foreground springGreen))
...
(provide-theme 'kanagawa-dragon-tmp)

...
(autothemer-deftheme
        office "A theme inspired by the colors of the famous painting by Katsushika Hokusa"
 ...
 ((((class color) (min-colors #xFFFFFF))        ; col 1 GUI/24bit
  ...
  (Green1               "#33BD77" "#33BD77")
  (Green2               "#24995C" "#24995C")
  (Green3               "#16713A" "#16713A")
  (Green4               "#195231" "#195231")
 ...
 (
  ...
  (cursor                                        (:background Gray3 :foreground White :bold t))
  (error                                         (:foreground Red4))
  ...
  ;; Font lock
  (font-lock-type-face                           (:foreground Blue2))
  ...
  (font-lock-string-face                         (:foreground Green2 :italic t))
  ...
  (font-lock-variable-name-face                  (:foreground Red3))
  (font-lock-negation-char-face                  (:foreground peachRed))
  (font-lock-comment-face                        (:foreground Gray1 :italic t))
  ...
  (doom-modeline-evil-insert-state               (:foreground Red1))
  (doom-modeline-evil-normal-state               (:foreground Blue1))
  (doom-modeline-evil-visual-state               (:foreground Green1))
  ...
  (org-level-1                                   (:foreground Red1 :bold t))
  (org-level-2                                   (:foreground springViolet2 :bold t))
  ...
  (company-scrollbar-fg                          (:background Red1))
